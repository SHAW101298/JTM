...
public class Runda2 : MonoBehaviour
{
    AudioClip[] utwory;
    ...
    {
        string sciezka = Application.dataPath + "/Dzwieki/Runda 2";
        ...
        for(int i = 0; i <= iloscPlikow; i++)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        Initialization.ins.WczytanoNastepnyUtwor("Runda 2");
                    }
                    else
                    {
                        Initialization.ins.WczytanoNastepnyUtwor("Runda 2", i);
                    }
                }
    ...
    bool ProbaWpisaniaAutoraiTytulu(string plik, int x)
    {
        ...
        else
        {
            ...
            string sciezka_do_folderu = Application.dataPath + "/Dzwieki/Runda 2/";
